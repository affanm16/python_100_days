...
# This allows you to use the functions and variables defined in the module in your current script, as well as
...
# **The 'dir' function***
# =>Finally, Python has a built-in function called 'di'r that you can use to view the names of all the functions and variables
...
from affan import welcome,affan
welcome()
print(affan)
