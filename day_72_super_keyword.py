...
=>The super() keyword in Python is used to refer to the parent class.
 It is especially useful when a class inherits from multiple parent classes, and you want to call a method
 from one of the parent classes.
...
class ChildClass(ParentClass):
    def child_method(self):
        ...
        super().parent_method()#parent method is also called in this method
...
overrides the child_method. 
When the child_method is called, it first prints "This is the child method." and then calls the parent_method 
...
In conclusion, the super() keyword is a useful tool in Python when you want to call a parent class method
 in a child class. It can be used in inheritance scenarios with a single parent class or multiple parent classes.
