...
=>The tell() function returns the current position within the file, in bytes. 
    This can be useful for keeping track of your location within the file or for seeking to a specific position 
...
with open('sample.txt', 'w') as f:
  f.write('Hello World!')
  f.truncate(5)#it has only 5 cahracters i.e 5 byte
