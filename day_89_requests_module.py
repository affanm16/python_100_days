...
=>The Python Requests module is an HTTP library that enables developers to send HTTP requests in Python.
 This module enables you to send HTTP requests using Python code and makes it possible to interact with APIs
 and web services.
...
response=requests.post(url,headers=headers,json=data)
print(response.text)"""
#parsing code with harry website
import requests
url="https://www.codewithharry.com/blogpost/django-cheatsheet/"
r=requests.get(url)
# print(r.text)
#using bs4 module  for
