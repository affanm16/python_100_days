...
=>A decorator is a function that takes another function as an argument and returns a new function that modifies the
    behavior of the original function. The new function is often referred to as a "decorated" function.
...
=>In this example, the log_function_call decorator takes a function as an argument and returns a new function that
...
=>Decorators are a powerful and flexible feature in Python that can be used to add functionality to
 ...
 They are a great tool for separating concerns, reducing code duplication, and making your code more readable
 and maintainable.

=>In conclusion, python decorators are a way to extend the functionality of functions and methods, by modifying
  its behavior without modifying the source code.
...
def greet(fx):
    ...
    return mfx
@greet#fx is hello an arguement to greet function
def hello():
    print("Hello World")
hello()
...
@greet
def pc():
    print("hello this is you computer")
pc()
# example2
import logging
...
def log_function_call(func):
    def decorated(*args, **kwargs):
        ...
        return result
    return decorated
# *args=>takes aarguements as tuples
#**kwargs->key value args->takes arguement as dictionary
@log_function_call
def my_function(a, b):
    return a + b
my_function(10,20)
