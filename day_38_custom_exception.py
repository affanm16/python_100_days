...
if(a<5 or a>9):
    raise ValueError("VALUE SHOULD BE BETWEEN 5 AND 9")#Custom error python cannot know,built in like if we input string
# instead of int ,python identifies it and raises an error(exception)
