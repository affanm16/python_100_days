...
class Person:
    name="affan"
    occ="develeoper"
    #generally when declaring any method inside class should have self arguement
    def info(self):
