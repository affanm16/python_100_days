...
In bigger programs, where we have large amounts of code, it is advisable to create or use existing functions
...
*'pass' is used when the function is declared but body will be written later
e.g  def func1(a):
        pass
"""
#geometric mean
